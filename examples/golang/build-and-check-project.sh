...
go build -o generated/myapiserver project/main.go
./generated/myapiserver > /dev/null 2>&1 &
SERVER_PID=$!
...
do
    ...
    curl --silent http://localhost:8080/v1/openapi.json > generated/openapi.json
    CURL_EXIT_CODE=$?
    ATTEMPTS=$((ATTEMPTS + 1))
done
